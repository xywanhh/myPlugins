...
/*
{"translation":["好"],"basic":{"us-phonetic":"ɡʊd","phonetic":"ɡʊd","uk-phonetic":"ɡʊd",
"explains":["n. 好处；善行；慷慨的行为","adj. 好的；优良的；愉快的；虔诚的","adv. 好","n. (Good)人名；(英)古德；(瑞典)戈德"]},
"query":"good","errorCode":0,
"web":[{"value":["好的","善","良好"],"key":"good"},
{"value":["早上好","早安","早晨好"],"key":"Good morning"},{"value":["永久地","永远","永恒地"],"key":"for good"}]}
*/
